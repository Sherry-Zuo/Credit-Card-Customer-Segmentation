...
# balance freq: both withdraw and saving 用户活动频率（消费，还款）
```{r}
par(mfrow = c(2,1))
...
# oneoff purchase: maximum amount 最高消费额度
```{r}
par(mfrow = c(2,1))
...
# oneoff purchase frequency: 最高消费更新频率
```{r}
par(mfrow = c(2,1))
...
# oneoff purchase: maximum amount 
```{r}
par(mfrow = c(2,1))
