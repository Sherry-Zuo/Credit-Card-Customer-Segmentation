...
cluster 2: spend more money, shopping more, high credit limit, buy expansive stuff, more purchases transaction, use cash less and amount small
cluster 3: spend less money, shopping less, less installment payments, less transactions, less installment amount
cluster 4: low credit limit, low using cards, low transactions, more frequently get cash
cluster 5: more shopping, high frequent installment purchases, not really cash back, high amount of installment pay, high purchase transactions, less amount cash back
